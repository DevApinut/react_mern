    ...
    return (
        <div>
            <div>
                    ...
                    <div className="d-flex justify-content-center align-items-center row width_max">
                        <div className="mx-3 col-lg-4 col-md-12 col-sm-12">
                            <div className="mainmenu">
                                ...
                                <button className="submenuselect Coil" onClick={() => selectmenutest("Coil")}>Coil</button>                                
                ...
                {(listtest === "Coil" && state.indexfeeder !== "") && <Coil index_feeder={state.indexfeeder} checked={state.switch_checked} setstate={dispatch} />}                
...
export default Menu_Switchyard