...
const Timing = (prop) => {
    ...
    const fetch = (nameThai, index = 0) => {
        ...
        axios.post(`${process.env.REACT_APP_API}/fetchdatatest`, { nameThai }, {
            ...
            .then(res => {
                console.log(prop.index_feeder)       
                dispatch({ type: 'Updatetiming', payload: { ...res.data.result.Switch_yard[index][prop.index_feeder].Timming } })
        ...
        <div>
            <form onSubmit={Updatetiming}>
                ...
                <div className="d-flex justify-content-center">
                    ...
                    <div className="mx-1">
                        <div className="input-group mb-3">
                            <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value={state.Time_open_log} />
                        </div>
                        <div className="input-group mb-3">
                            <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value={state.Time_close_log} />
                        </div>
                        <div className="input-group mb-3">
                            <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value={state.Time_motor_log} />
                        </div>
                        <div className="input-group mb-3">
                            <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value={state.Current_open_log} />
                        </div>
                        <div className="input-group mb-3">
                            <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value={state.Current_close_log} />
                        </div>
                        <div className="input-group mb-3">
                            <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value={state.Current_motor_log} />
                        </div>
                    </div>
                </div>
