...
const Vaccuum = (prop) => {
    ...
    const Updatevaccuum = (e) => {
        e.preventDefault()
        axios.post(`${process.env.REACT_APP_API}/Updatevaccuum`, { nameThai: substation, Feeder: sublisttest, ...state, index_array: state.index_new_data }, {
            headers: {
    ...
    const fetch = (nameThai, index = 0) => {
        ...
        axios.post(`${process.env.REACT_APP_API}/fetchdatatest`, { nameThai }, {
            ...
            .then(res => {
                // console.log(prop.index_feeder)       
                dispatch({ type: 'Update_vaccuum', payload: { ...res.data.result.switchgear_CB[index][prop.index_feeder].Vaccuum } })
    ...
    return (
        <div>
            <form onSubmit={Updatevaccuum}>
                <div className="d-flex justify-content-center">
                    <div className="text-center"><h4>Vaccuum test</h4></div>
